    ...
    public class CartController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            catch (Exception ex)
            {
                ...
                TempData["Error"] = "Có l?i khi t?i danh sách gi? hàng";
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            catch (Exception ex)
            {
                ...
                TempData["Error"] = "Có l?i khi t?i chi ti?t gi? hàng";
        ...
        public async Task<IActionResult> Create()
        {
            ...
            catch (Exception ex)
            {
                ...
                TempData["Error"] = "Có l?i khi t?i form t?o gi? hàng";
                return RedirectToAction(nameof(Index));
            }
        }
        ...
        public async Task<IActionResult> Create([Bind("CustomerId")] Cart cart)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    TempData["Success"] = "T?o gi? hàng thành công";
                    return RedirectToAction(nameof(Index));
                }
                catch (Exception ex)
                {
                    _logger.LogError(ex, "Error creating cart");
                    ModelState.AddModelError("", "Có l?i khi t?o gi? hàng");
                }
            }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            catch (Exception ex)
            {
                ...
                TempData["Error"] = "Có l?i khi t?i gi? hàng";
                return RedirectToAction(nameof(Index));
            }
        }
        ...
        public async Task<IActionResult> Edit(int id, [Bind("CartId,CustomerId,CreatedDate")] Cart cart)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    await _context.SaveChangesAsync();
                    TempData["Success"] = "C?p nh?t gi? hàng thành công";
                    return RedirectToAction(nameof(Index));
                }
                ...
                catch (Exception ex)
                {
                    ...
                    ModelState.AddModelError("", "Có l?i khi c?p nh?t gi? hàng");
                }
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            try
            {
                ...
                if (cart != null)
                {
                    ...
                    await _context.SaveChangesAsync();
                    TempData["Success"] = "Xóa gi? hàng thành công";
                }
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "Error deleting cart");
                TempData["Error"] = "Có l?i khi xóa gi? hàng";
            }
