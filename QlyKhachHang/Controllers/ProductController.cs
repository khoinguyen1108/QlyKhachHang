    ...
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            catch (Exception ex)
            {
                ...
                TempData["Error"] = "Có l?i khi t?i danh sách s?n ph?m";
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            catch (Exception ex)
            {
                ...
                TempData["Error"] = "Có l?i khi t?i chi ti?t s?n ph?m";
        ...
        public async Task<IActionResult> Create([Bind("ProductName,Description,Price,Stock,Category")] Product product)
        {
            if (ModelState.IsValid)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    ModelState.AddModelError("", "Có l?i khi thêm s?n ph?m");
                }
            }
            return View(product);
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            catch (Exception ex)
            {
                ...
                TempData["Error"] = "Có l?i khi t?i s?n ph?m";
                return RedirectToAction(nameof(Index));
            }
        }
        ...
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,ProductName,Description,Price,Stock,Category,CreatedDate")] Product product)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    ModelState.AddModelError("", "Có l?i khi c?p nh?t s?n ph?m");
                }
            }
            return View(product);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            try
            {
                ...
                if (product != null)
                {
                    ...
                    {
                        TempData["Error"] = "Không th? xóa s?n ph?m vì còn d? li?u liên quan (Gi? hàng, ?ánh giá, Hóa ??n)";
                        return RedirectToAction(nameof(Index));
                    }
            ...
            catch (Exception ex)
            {
                ...
                TempData["Error"] = "Có l?i khi xóa s?n ph?m";
            }
